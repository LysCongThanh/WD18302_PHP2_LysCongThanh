...
<head>
    ...
    <link href="<?= $app->url('assets/css/nucleo-icons.css') ?>" rel="stylesheet"/>
    <link href="<?= $app->url('assets/css/nucleo-svg.css') ?>" rel="stylesheet"/>

    <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
    <link href="<?= $app->url('assets/css/nucleo-svg.css') ?>" rel="stylesheet"/>

    <link id="pagestyle" href="<?= $app->url('assets/css/argon-dashboard.min.css') ?>?" rel="stylesheet"/>
...
<script src="../../../assets/js/pljsugins/jkanban/jkanban.js"></script>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317"
        ...
        data-cf-beacon='{"rayId":"8465aac18b35227f","version":"2023.10.0","token":"1b7cbb72744b40c580f8633c6b62637e"}'
        crossorigin="anonymous"></script>

<!-- <script src="<?= $app->url('assets/dist/services.bundle.js') ?>"></script> -->
